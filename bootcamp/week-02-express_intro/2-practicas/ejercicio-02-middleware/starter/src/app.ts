...
// import { logger } from './middlewares/logger.js';          // se importa en Paso 4
// import { auth } from './middlewares/auth.js';              // se importa en Paso 4
// import { errorHandler } from './middlewares/errorHandler.js'; // se importa en Paso 4
